...
@Bean
    @Primary
    OtlpLoggingConnectionDetails otlpLoggingConnectionDetailsForLgtm(
            OtlpLoggingConnectionDetails otlpLoggingConnectionDetailsForTodosrestclientOtelLgtm1) {
        return otlpLoggingConnectionDetailsForTodosrestclientOtelLgtm1;
    }
    @Bean
